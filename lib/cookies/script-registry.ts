  ...
  return [
    {
      ...
      load: () => {
        ...
        injectScript("ice-gtag-js", `https://www.googletagmanager.com/gtag/js?id=${gaId}`);
        const inline = document.createElement("script");
        inline.id = "ice-gtag-inline";
        inline.textContent = `
      ...
      unload: () => {
        removeScript("ice-gtag-js");
        removeInlineScript("ice-gtag-inline");
    ...
    },
    {
      ...
      unload: () => {
        removeInlineScript("ice-gtm-inline");
        removeScript(`ice-gtm-external-${gtmId}`);
    ...
    },
    {
      ...
      unload: () => {
        removeInlineScript("ice-meta-pixel");
    ...
    },
    {
      ...
      load: () => {
        ...
        const inline = document.createElement("script");
        inline.id = "ice-linkedin-insight";
        inline.textContent = `
      ...
      unload: () => {
        removeInlineScript("ice-linkedin-insight");
        removeScript("ice-linkedin-js");
...
/** Apply load/unload based on current consent */
