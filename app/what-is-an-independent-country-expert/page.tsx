  ...
  return (
    <>
      ...
      <PageShell
        ...
        subtitle="The tribunal-duty role of country expert witnesses in UK asylum and immigration proceedings."
        breadcrumbs={crumbs}
      >
        ...
        <h2 className="mt-8 text-xl font-bold text-[#2C3E50]">What Independent Country Experts Do</h2>
        ...
        <h2 className="mt-8 text-xl font-bold text-[#2C3E50]">Independent vs Generic Country Evidence</h2>
        <p className="mt-4 text-[#374151] leading-relaxed">
