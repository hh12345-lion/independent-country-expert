  ...
  return (
    <>
      ...
      >
        ...
        <h2
          id="ikarian-reefer"
          className="scroll-mt-24 text-xl font-bold text-[#0F241C]"
        >
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0F241C]">The Independence Framework — Key Duties Table</h2>
        <div className="mt-6">
          ...
          <table className="w-full min-w-[480px] border-collapse text-sm">
            <thead>
              <tr className="border-b border-[#B8C4BE] bg-[#E7ECE8]">
                <th className="px-3 py-3 text-left font-semibold text-[#0F241C] sm:px-4">Duty</th>
                <th className="px-3 py-3 text-left font-semibold text-[#0F241C] sm:px-4">Legal Source</th>
                <th className="px-3 py-3 text-left font-semibold text-[#0F241C] sm:px-4">2025–2026 Tribunal Expectation</th>
              </tr>
            </thead>
            <tbody>
              {dutiesTable.map(([duty, source, expectation]) => (
                <tr key={duty} className="border-b border-[#B8C4BE]">
                  <td className="px-3 py-3 font-medium text-[#0F241C] sm:px-4">{duty}</td>
                  <td className="px-3 py-3 text-[#33403A] sm:px-4">{source}</td>
                  <td className="px-3 py-3 text-[#33403A] sm:px-4">{expectation}</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0F241C]">
            ...
            <table className="w-full min-w-[480px] border-collapse text-sm">
              <thead>
                <tr className="border-b border-[#B8C4BE] bg-[#E7ECE8]">
                  ...
                  <th className="px-3 py-3 text-left font-semibold text-[#0F241C] sm:px-4">Scope</th>
                  <th className="px-3 py-3 text-left font-semibold text-[#0F241C] sm:px-4">Country Expert Application</th>
                </tr>
              </thead>
              <tbody>
                {frameworkComparison.map(([framework, scope, application]) => (
                  <tr key={framework} className="border-b border-[#B8C4BE]">
                    ...
                    <td className="px-3 py-3 text-[#33403A] sm:px-4">{scope}</td>
                    <td className="px-3 py-3 text-[#33403A] sm:px-4">{application}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <h2
          id="cpr-part-35"
          className="scroll-mt-24 mt-10 text-xl font-bold text-[#0F241C]"
        >
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0F241C]">Country Expert vs Home Office CPIN</h2>
        <p className="mt-4 text-[#33403A] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0F241C]">Oral Evidence and Cross-Examination</h2>
        <p className="mt-4 text-[#33403A] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0F241C]">Choosing an Independent Country Expert</h2>
        <p className="mt-4 text-[#33403A] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0F241C]">Network Routing by Jurisdiction</h2>
        <p className="mt-4 text-[#33403A] leading-relaxed">
        ...
        <p className="mt-4 text-[#33403A] leading-relaxed">
          ...
          <Link href="/network" className="font-semibold text-[#2B7A78] hover:underline">
            network directory
          </Link>{" "}
        ...
        <p className="mt-4 text-[#33403A] leading-relaxed">
          Related definitions:{" "}
          <Link href="/glossary#ikarian-reefer" className="font-semibold text-[#2B7A78] hover:underline">
            Ikarian Reefer glossary
          </Link>
          ,{" "}
          <Link href="/glossary#cpr-part-35" className="font-semibold text-[#2B7A78] hover:underline">
            CPR Part 35
          </Link>
          , and{" "}
          <Link href="/report-standards" className="font-semibold text-[#2B7A78] hover:underline">
            report standards
          </Link>
          .
        </p>
        ...
        <Link
          href="/contact"
          className="mt-8 inline-flex min-h-[44px] w-full items-center justify-center rounded-[8px] bg-[#2B7A78] px-6 py-3 font-semibold text-white hover:bg-[#236663] sm:w-auto"
        >
          Contact Us
        </Link>
      </PageShell>
