  ...
  return (
    <>
      ...
      >
        ...
        <h2
          id="ikarian-reefer"
          className="scroll-mt-24 text-xl font-bold text-[#2C3E50]"
        >
        ...
        <h2 className="mt-10 text-xl font-bold text-[#2C3E50]">The Independence Framework — Key Duties Table</h2>
        <div className="mt-6">
          ...
          <table className="w-full min-w-[480px] border-collapse text-sm">
            <thead>
              <tr className="border-b border-[#CBD5E1] bg-[#F5F7FA]">
                <th className="px-3 py-3 text-left font-semibold text-[#2C3E50] sm:px-4">Duty</th>
                <th className="px-3 py-3 text-left font-semibold text-[#2C3E50] sm:px-4">Legal Source</th>
                <th className="px-3 py-3 text-left font-semibold text-[#2C3E50] sm:px-4">2025–2026 Tribunal Expectation</th>
              </tr>
            </thead>
            <tbody>
              {dutiesTable.map(([duty, source, expectation]) => (
                <tr key={duty} className="border-b border-[#CBD5E1]">
                  <td className="px-3 py-3 font-medium text-[#2C3E50] sm:px-4">{duty}</td>
                  <td className="px-3 py-3 text-[#374151] sm:px-4">{source}</td>
                  <td className="px-3 py-3 text-[#374151] sm:px-4">{expectation}</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#2C3E50]">
        ...
        <div className="mt-6">
          <ResponsiveTableWrap label="Swipe to view framework comparison table">
            <table className="w-full min-w-[480px] border-collapse text-sm">
              <thead>
                <tr className="border-b border-[#CBD5E1] bg-[#F5F7FA]">
                  <th className="px-3 py-3 text-left font-semibold text-[#2C3E50] sm:px-4">Framework</th>
                  <th className="px-3 py-3 text-left font-semibold text-[#2C3E50] sm:px-4">Scope</th>
                  <th className="px-3 py-3 text-left font-semibold text-[#2C3E50] sm:px-4">Country Expert Application</th>
                </tr>
              </thead>
              <tbody>
                {frameworkComparison.map(([framework, scope, application]) => (
                  <tr key={framework} className="border-b border-[#CBD5E1]">
                    <td className="px-3 py-3 font-medium text-[#2C3E50] sm:px-4">{framework}</td>
                    <td className="px-3 py-3 text-[#374151] sm:px-4">{scope}</td>
                    <td className="px-3 py-3 text-[#374151] sm:px-4">{application}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <h2
          id="cpr-part-35"
          className="scroll-mt-24 mt-10 text-xl font-bold text-[#2C3E50]"
        >
        ...
        <h2 className="mt-10 text-xl font-bold text-[#2C3E50]">Country Expert vs Home Office CPIN</h2>
        <p className="mt-4 text-[#374151] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#2C3E50]">Oral Evidence and Cross-Examination</h2>
        <p className="mt-4 text-[#374151] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#2C3E50]">Choosing an Independent Country Expert</h2>
        <p className="mt-4 text-[#374151] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#2C3E50]">Network Routing by Jurisdiction</h2>
        <p className="mt-4 text-[#374151] leading-relaxed">
        ...
        <p className="mt-4 text-[#374151] leading-relaxed">
          ...
          <Link href="/network" className="font-semibold text-[#B87333] hover:underline">
            network directory
          </Link>{" "}
        ...
        <p className="mt-4 text-[#374151] leading-relaxed">
          Related definitions:{" "}
          <Link href="/glossary#ikarian-reefer" className="font-semibold text-[#B87333] hover:underline">
            Ikarian Reefer glossary
          </Link>
          ,{" "}
          <Link href="/glossary#cpr-part-35" className="font-semibold text-[#B87333] hover:underline">
            CPR Part 35
          </Link>
          , and{" "}
          <Link href="/report-standards" className="font-semibold text-[#B87333] hover:underline">
            report standards
          </Link>
          .
        </p>
        ...
        <Link
          href="/contact"
          className="mt-8 inline-flex min-h-[44px] w-full items-center justify-center rounded-[8px] bg-[#B87333] px-6 py-3 font-semibold text-white hover:bg-[#9A6129] sm:w-auto"
        >
          Contact Us
        </Link>
      </PageShell>
