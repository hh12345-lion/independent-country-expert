    ...
    <>
      ...
      <PageShell title={area.h1} breadcrumbs={crumbs}>
        ...
        {area.relatedExpertise.length > 0 && (
          <>
            <h2 className="mt-8 text-lg font-bold text-[#2C3E50]">Related Expertise</h2>
                ...
                return (
                  <li key={s}>
                    <Link
                      ...
                      className="inline-flex min-h-[44px] items-center text-[#B87333] hover:underline"
                    >
                      {related?.title ?? s}
                    </Link>
                  </li>
      ...
      <div className="border-t border-[#CBD5E1] bg-[#F5F7FA]">
