  ...
  return (
    <>
      ...
      >
        ...
        <h2 className="mt-8 text-xl font-bold text-[#2C3E50]">Framework Comparison</h2>
        <div className="mt-6">
            ...
            <table className="w-full min-w-[480px] border-collapse text-sm">
              <thead>
                <tr className="border-b border-[#CBD5E1] bg-[#F5F7FA]">
                  ...
                  <th className="px-3 py-3 text-left font-semibold text-[#2C3E50] sm:px-4">Applies To</th>
                  <th className="px-3 py-3 text-left font-semibold text-[#2C3E50] sm:px-4">Key Principle</th>
                </tr>
              </thead>
              <tbody>
                {frameworkTable.map(([framework, applies, principle]) => (
                  <tr key={framework} className="border-b border-[#CBD5E1]">
                    ...
                    <td className="px-3 py-3 text-[#374151] sm:px-4">{applies}</td>
                    <td className="px-3 py-3 text-[#374151] sm:px-4">{principle}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#2C3E50]">CPIN vs Independent Country Expert Report</h2>
        <div className="mt-6">
          <ResponsiveTableWrap label="Swipe to view CPIN vs expert comparison">
            <table className="w-full min-w-[480px] border-collapse text-sm">
              <thead>
                <tr className="border-b border-[#CBD5E1] bg-[#F5F7FA]">
                  <th className="px-3 py-3 text-left font-semibold text-[#2C3E50] sm:px-4">Dimension</th>
                  <th className="px-3 py-3 text-left font-semibold text-[#2C3E50] sm:px-4">Home Office CPIN</th>
                  <th className="px-3 py-3 text-left font-semibold text-[#2C3E50] sm:px-4">Independent Expert Report</th>
                </tr>
              </thead>
              <tbody>
                {cpinVsExpertTable.map(([dimension, cpin, expert]) => (
                  <tr key={dimension} className="border-b border-[#CBD5E1]">
                    <td className="px-3 py-3 font-medium text-[#2C3E50] sm:px-4">{dimension}</td>
                    <td className="px-3 py-3 text-[#374151] sm:px-4">{cpin}</td>
                    <td className="px-3 py-3 text-[#374151] sm:px-4">{expert}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#2C3E50]">Country-Specific Guidance Resources</h2>
        ...
        <ul className="mt-4 space-y-2 text-[#374151]">
          <li>
            <a href="https://www.somaliaexpert.com/moj-country-guidance" target="_blank" rel="noopener noreferrer" className="text-[#B87333] hover:underline">
              Somalia MOJ Country Guidance
            </a>{" "}
            — Somalia Expert
          </li>
          <li>
            <a href="https://www.pakistancountryexpert.com/cpin-country-guidance" target="_blank" rel="noopener noreferrer" className="text-[#B87333] hover:underline">
              Pakistan CPIN & MN Country Guidance
            </a>{" "}
            — Pakistan Country Expert
          </li>
          <li>
            <a href="https://www.nigeriaexpert.com/cpin-country-guidance" target="_blank" rel="noopener noreferrer" className="text-[#B87333] hover:underline">
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
          <Link href="/guides/cpin-vs-expert-report-guide" className="inline-flex min-h-[44px] items-center font-semibold text-[#B87333] hover:underline">
            CPIN vs Independent Expert Report guide
          </Link>
          <Link href="/expertise-areas/cpin-challenge-reports" className="inline-flex min-h-[44px] items-center font-semibold text-[#B87333] hover:underline">
