...
export default function NotFound() {
  return (
    <section className="bg-[#2C3E50] py-14 text-center md:py-20">
      <div className="mx-auto max-w-3xl px-4 sm:px-6">
        <p className="text-7xl font-bold text-[#B87333] sm:text-8xl" aria-hidden="true">
          404
        </p>
        ...
        <div className="mt-10 flex w-full max-w-md flex-col items-stretch gap-3 sm:mx-auto sm:max-w-none sm:flex-row sm:items-center sm:justify-center sm:gap-4">
          <Link
            href="/"
            className="inline-flex min-h-[44px] w-full items-center justify-center rounded-[8px] bg-[#B87333] px-6 py-3 font-semibold text-white transition hover:bg-[#9A6129] sm:w-auto sm:min-w-[200px] sm:px-8"
          >
            Return to Homepage
          </Link>
          <Link
